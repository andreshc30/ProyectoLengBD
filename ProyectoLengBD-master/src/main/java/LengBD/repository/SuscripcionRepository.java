...
public interface SuscripcionRepository extends JpaRepository<Suscripcion, Integer>{
    ...
    @Procedure(procedureName = "FIDE_FECHA_FINAL_SUSCRIPCION_SP")
    void fechaFinalSuscripcionSP(
    ...
    @Procedure(procedureName = "FIDE_ALERTA_SUSCRIPCION_SP")
    void alertaSuscripcionSP(
        @Param("P_CEDULA") Integer cedula,
        @Param("P_NOMBRE_SUSCRIPCION") String nombre,
        @Param("P_FECHA_FINAL") Date fechaFinal,
