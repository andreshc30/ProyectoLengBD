...
public interface ProvinciaRepository extends JpaRepository<Provincia, Integer>{
    ...
    @Procedure(procedureName = "FIDE_PROVINCIA_INSERT_SP")
    ...
    @Procedure(procedureName = "FIDE_PROVINCIA_UPDATE_SP")
    ...
    @Procedure(procedureName = "FIDE_PROVINCIA_DELETE_LOGICO_SP")
